/**
 * <p>Title: UncompressInputStream</p>
 * <p>Description:</p>
 * @author Bradley Gude
 * @version 1.0
 */
...
public class UncompressInputStream extends FilterInputStream {
    ...
    public static File ZUnZipFile(File file, boolean b) {
        try {
            InputStream in = new UncompressInputStream(new FileInputStream(file));
            File outFile = new File(file.getAbsolutePath().replaceAll(".Z", ""));
